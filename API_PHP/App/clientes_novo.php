...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $results = api_request('create_client','POST', $data);
            ...
            <div class="col-sm-6 offset-sm-3 card bg-light p-4">
                ...
                <form action="clientes_novo.php" method="POST">
                    <div class="mb-3 text-center">
                        <h3>Formulário - Cadastro de Cliente</h3>
                    </div>
                    ...
                    <div class="mb-3 text-center">
                        <input type="submit" name="Enviar" value="Cadastrar" class="btn btn-primary btn-md ">   
